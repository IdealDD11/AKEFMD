# -*- coding: utf-8 -*-
"""
Created on Wed Jul 20 16:09:14 2022
...
class KHLACFKoopmanEigenfunctions(BasisFunctions):
    """
    ...
    def build_diffeomorphism_model(self, jacobian_penalty=1., n_hidden_layers=2, layer_width=50, batch_size=64, dropout_prob=0.1):
        ...
        self.diffeomorphism_model = HLAttentionCouplingDiffeomorphismNet(self.n, self.A_cl, jacobian_penalty=jacobian_penalty,

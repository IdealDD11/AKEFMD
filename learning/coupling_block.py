# -*- coding: utf-8 -*-
"""
Created on Fri Jul 15 21:42:17 2022
...
class CouplingBlock(nn.Module):
    ...
    '''
    def __init__(self, s_t_network, input_dimension_1,input_dimension_2):
        super().__init__()
        self.channel_part_1 = input_dimension_1 // 2
        self.channel_part_2 = input_dimension_1 - input_dimension_1 // 2
        self.s_net = s_t_network(self.channel_part_1 , self.channel_part_1)
        self.t_net = s_t_network(self.channel_part_2 , self.channel_part_2)

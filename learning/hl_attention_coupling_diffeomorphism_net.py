# -*- coding: utf-8 -*-
"""
Created on Wed Jul 20 16:08:21 2022
...
class HLAttentionCouplingDiffeomorphismNet(nn.Module):
    ...
    def __init__(self, n, A_cl, jacobian_penalty = 1e-2, n_hidden_layers = 2, layer_width=50, batch_size = 64, dropout_prob=0.1, traj_input=False):
        super(HLAttentionCouplingDiffeomorphismNet, self).__init__()
        self.n = n

# -*- coding: utf-8 -*-
"""
Created on Wed Sep 20 22:29:04 2023
...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 15 16:48:09 2022
...
from .coupling_diffeomorphism_net_improved import CouplingDiffeomorphismNetImp
...
class KFIMPKoopmanEigenfunctions(BasisFunctions):
    """
    ...
    def build_diffeomorphism_model(self, jacobian_penalty=1., n_hidden_layers=2, layer_width=50, batch_size=64, dropout_prob=0.1):
        ...
        self.diffeomorphism_model = CouplingDiffeomorphismNet(self.n, self.A_cl, jacobian_penalty=jacobian_penalty,

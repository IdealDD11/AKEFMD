# -*- coding: utf-8 -*-
"""
Created on Tue Jul 19 21:41:05 2022
...
class KACFKoopmanEigenfunctions(BasisFunctions):
    """
    ...
    def construct_linear_eigfuncs(self):
        ...
        self.Lambda = log(prod(power(exp(lambd).reshape((self.n,1)), transpose(powerss)), axis=0))  # Calculate corresponding eigenvalues
    ...
    def construct_scaling_function(self,ub,lb):
        ...
        if ub!=None:
            ...
            # scale_factor = 10**(0)*np.ones((self.n,1))
            scale_func = lambda q: divide(q, scale_factor)
    ...
    def build_diffeomorphism_model(self, jacobian_penalty=1., n_hidden_layers=2, layer_width=50, batch_size=64, dropout_prob=0.1):
        ...
        self.diffeomorphism_model = AttentionCouplingDiffeomorphismNet(self.n, self.A_cl, jacobian_penalty=jacobian_penalty,
